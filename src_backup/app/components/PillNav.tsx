              ...
              <li key={item.href || `item-${i}`} role="none">
                {isRouterLink(item.href) ? (
                  <Link
                    ...
                    to={item.href}
                    onClick={(e) => {
                      if (item.onClick) item.onClick(e, item.href);
                    }}
                  ...
                  >
                    ...
                    />
                    <span className="label-stack text-sm">
                      <span className="pill-label font-medium">{item.label}</span>
                      <span className="pill-label-hover font-medium" aria-hidden="true">
                        {item.label}
                      </span>
                    </span>
                  </Link>
